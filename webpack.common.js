...
const blogPostHtmlPlugins = blogPostDirs.flatMap((d) => {
  ...
  return [
    new HtmlWebpackPlugin({
      template: htmlPath,
      filename: `blog_posts/${d.name}/index.html`,
